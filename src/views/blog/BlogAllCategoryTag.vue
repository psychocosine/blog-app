        ...
        <el-tabs v-model="activeName">
          <el-tab-pane label="文章分类" name="category">
            <ul class="me-allct-items">
              <li v-for="c in categorys" @click="view(c.categoryname)" :key="c.categoryname" class="me-allct-item">
                <div class="me-allct-content">
                  ...
                  <div class="me-allct-meta">
                    <span>{{c.number_with_this}} 文章</span>
                  </div>
                </div>
              </li>
            </ul>
          ...
          <el-tab-pane label="标签" name="tag">
            <ul class="me-allct-items">
              <li v-for="t in tags" @click="view(t.name)" :key="t.name" class="me-allct-item">
                <div class="me-allct-content">
                  <a class="me-allct-info">
                  ...
                  <div class="me-allct-meta">
                    <span>{{t.number_with_this}}  文章</span>
                  </div>
                </div>
              </li>
            </ul>
...
<script>
  ...
  export default {
    ...
    methods: {
      view(id) {
        this.$router.push({path: `/type/${this.currentActiveName}/${id}`})
      },
      getCategorys() {
        let that = this
