      ...
      <el-main>
        ...
        <div class="me-view-card">
          ...
          <div class="me-view-tag">
            ...
            <el-button @click="tagOrCategory('type/tag', t.id)" size="mini" type="primary" v-for="t in article.tags" :key="t.id" round plain>{{t.tagname}}</el-button>
          </div>

          <div class="me-view-tag">
            文章分类：
            <!--<span style="font-weight: 600">{{article.category.categoryname}}</span>-->
            <el-button @click="tagOrCategory('type/category', article.category.id)" size="mini" type="primary" round plain>{{article.category.categoryname}}</el-button>
          </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleteArticle() {
        deleteArticle(this.$route.params.id).then(r=>{
